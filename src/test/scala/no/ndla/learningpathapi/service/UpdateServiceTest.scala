...
class UpdateServiceTest extends UnitSuite with TestEnvironment {
  ...
  val STEP3 = LearningStep(Some(3), None, None, 2, List(), List(), List(), StepType.TEXT, None)
  val STEP4 = LearningStep(Some(4), None, None, 3, List(), List(), List(), StepType.TEXT, None)
  val STEP5 = LearningStep(Some(5), None, None, 4, List(), List(), List(), StepType.TEXT, None)
  val STEP6 = LearningStep(Some(6), None, None, 5, List(), List(), List(), StepType.TEXT, None)

  val NEW_STEP: NewLearningStep = NewLearningStep(List(), List(), List(), "", None)

  val PUBLISHED_LEARNINGPATH = LearningPath(Some(PUBLISHED_ID), None, List(), List(), None, Some(1), model.LearningPathStatus.PUBLISHED, model.LearningPathVerificationStatus.EXTERNAL, new Date(), List(), PUBLISHED_OWNER, STEP1 :: STEP2 :: STEP3 :: STEP4 :: STEP5 :: STEP6 :: Nil)
  val PRIVATE_LEARNINGPATH = LearningPath(Some(PRIVATE_ID), None, List(), List(), None, Some(1), model.LearningPathStatus.PRIVATE, model.LearningPathVerificationStatus.EXTERNAL, new Date(), List(), PRIVATE_OWNER, STEP1 :: STEP2 :: STEP3 :: STEP4 :: STEP5 :: STEP6 :: Nil)
