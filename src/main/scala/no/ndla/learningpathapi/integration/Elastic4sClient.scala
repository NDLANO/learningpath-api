...
import no.ndla.learningpathapi.model.domain.Ndla4sSearchException
...
object Elastic4sClientFactory {
  def getClient(searchServer: String = LearningpathApiProperties.SearchServer): NdlaE4sClient = {
