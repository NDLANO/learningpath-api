...
case class Description(@(ApiModelProperty@field)(description = "The learningpath description. Basic HTML allowed") description: String,
                       @(ApiModelProperty@field)(description = "ISO 639-1 code that represents the language used in description") language: String) extends LanguageField[String] { override def value: String = description }
