...
case class LearningPathV2(
    ...
    @(ApiModelProperty @field)(description = "The learningsteps-summaries for this learningpath") learningsteps: Seq[
    ...
    @(ApiModelProperty @field)(description = "Information about where the cover photo can be found") coverPhoto: Option[
      CoverPhoto],
