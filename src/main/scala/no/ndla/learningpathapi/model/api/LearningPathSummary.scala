...
case class LearningPathSummaryV2(
    ...
    @(ApiModelProperty @field)(description =
      "The descriptions of the learningpath") description: Description,
    @(ApiModelProperty @field)(description =
      "The introductions of the learningpath") introduction: Introduction,
    @(ApiModelProperty @field)(description =
      "The full url to where the complete metainformation about the learningpath can be found") metaUrl: String,
    @(ApiModelProperty @field)(description =
      "Url to where a cover photo can be found") coverPhotoUrl: Option[String],
    @(ApiModelProperty @field)(description =
    ...
    @(ApiModelProperty @field)(description =
      "The contributors of this learningpath") copyright: Copyright,
    @(ApiModelProperty @field)(description =
