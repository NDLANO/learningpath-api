...
class UrlValidator() {
  ...
  private def nonEmptyText(fieldPath: String,
                           url: String): Seq[ValidationMessage] = {
    if (url.isEmpty) {
  ...
  private def noHtmlInText(fieldPath: String,
                           url: String): Seq[ValidationMessage] = {
  ...
  private def urlIsValid(fieldPath: String,
                         url: String): Seq[ValidationMessage] = {
